...
class TugraTI2V:
    ...
    def __init__(
        ...
        r"""
        Initializes the Tugra text-to-video generation model components.
        ...
        self.vae = Tugra2_2_VAE(
            vae_pth=os.path.join(checkpoint_dir, config.vae_checkpoint),
            device=self.device)

        logging.info(f"Creating TugraModel from {checkpoint_dir}")
        self.model = TugraModel.from_pretrained(checkpoint_dir)
